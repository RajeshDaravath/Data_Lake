...
CustomerCurated_node1682743021739 = glueContext.create_dynamic_frame.from_options(
    format_options={"multiline": False},
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://stedi-s3/customer/curated/"], "recurse": True},
    transformation_ctx="CustomerCurated_node1682743021739",
)
